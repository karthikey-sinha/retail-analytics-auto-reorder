...
for i in range(1000):
    ...
    try :
        ...
        print("Data generated and saved to Superstore_Management_System.csv")
    except PermissionError:
        print("Permission denied: Please close the file if it's open and try again.")
